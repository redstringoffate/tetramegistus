...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/n6_aspects_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/nigredo/n6_aspects.xlsx'))
...
def compile_n6_aspects_grimoire(chart_data, seed_data=None):
    ...
    # 위에서 입혀진 4원소 컬러링(color 속성)은 그대로 보존하면서 폰트 이름만 일괄 교체합니다.
