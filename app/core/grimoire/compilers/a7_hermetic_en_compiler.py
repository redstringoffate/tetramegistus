...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/a7_hermetic_en_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/albedo/a7_hermetic_en.xlsx'))
