...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/c1_ko_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/citrinitas/c1_ko.xlsx'))
...
# 🚀 2. 동적 매트릭스 엔진
# ====================================================================
def compile_c1_ko_grimoire(chart_data, seed_data=None):
