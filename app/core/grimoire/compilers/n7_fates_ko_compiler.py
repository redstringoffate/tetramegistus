...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/n7_fates_ko_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/nigredo/n7_fates_ko.xlsx'))
...
def compile_n7_fates_ko_grimoire(chart_data, seed_data=None):
