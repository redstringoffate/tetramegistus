...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/a8_sys_en_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/albedo/a8_sys_en.xlsx'))
...
def compile_a8_sys_en_grimoire(chart_data, seed_data=None):
