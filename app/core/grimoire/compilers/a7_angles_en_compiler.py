...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/a7_angles_en_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/albedo/a7_angles_en.xlsx'))
...
def compile_a7_angles_en_grimoire(chart_data, seed_data=None):
