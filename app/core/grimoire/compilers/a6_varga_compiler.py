...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/a6_varga_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/albedo/a6_varga.xlsx'))
...
def compile_a6_varga_grimoire(chart_data, seed_data=None):
