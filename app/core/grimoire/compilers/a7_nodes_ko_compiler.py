...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/a7_nodes_ko_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/albedo/a7_nodes_ko.xlsx'))
...
def compile_a7_nodes_ko_grimoire(chart_data, seed_data=None):
