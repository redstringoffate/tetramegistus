...
MAPPING_FILE = os.path.abspath(os.path.join(BASE_DIR, '../mappings/n6_varga_kp_mapping.json'))
TEMPLATE_FILE = os.path.abspath(os.path.join(BASE_DIR, '../../../templates_excel/nigredo/n6_varga_kp.xlsx'))
...
def compile_n6_varga_kp_grimoire(chart_data, seed_data=None):
